      ...
      <BrowserRouter>
        <div className="App">
          ...
          <Switch>
            ...
            <PrivateRoute path="/home" render={(props) => <HomePage {...props} currentPrices={this.state.currentPrices} />} />
            <PrivateRoute path="/Portfolio" render={(props) => <Portfolio {...props} currentPrices={this.state.currentPrices} /> } />
            <Route path="/SignUp" render={() => (localStorage.userID ? (<Redirect to="/home" />) : (<SignUp />))} />
          </Switch>
        </div>
      </BrowserRouter>
    );
